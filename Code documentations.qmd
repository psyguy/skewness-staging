...
+============================+===================================================================+==================================================================+
| Bias                       | [{{< fa file-pdf >}}](./figures/Correlation (Bias).pdf)           | [{{< fa file-pdf >}}](./figures/Covariance (Bias).pdf)           |
+----------------------------+-------------------------------------------------------------------+------------------------------------------------------------------+
| Variance                   | [{{< fa file-pdf >}}](./figures/Correlation (Variance).pdf)       | [{{< fa file-pdf >}}](./figures/Covariance (Variance).pdf)       |
+----------------------------+-------------------------------------------------------------------+------------------------------------------------------------------+
| RMSE                       | [{{< fa file-pdf >}}](./figures/Correlation (RMSE).pdf)           | [{{< fa file-pdf >}}](./figures/Covariance (RMSE).pdf)           |
+----------------------------+-------------------------------------------------------------------+------------------------------------------------------------------+
| MAE                        | [{{< fa file-pdf >}}](./figures/Correlation (MAE).pdf)            | [{{< fa file-pdf >}}](./figures/Covariance (MAE).pdf)            |
+----------------------------+-------------------------------------------------------------------+------------------------------------------------------------------+
| Positive Type-I error rate | [{{< fa file-pdf >}}](./figures/Correlation (Positive error).pdf) | [{{< fa file-pdf >}}](./figures/Covariance (Positive error).pdf) |
+----------------------------+-------------------------------------------------------------------+------------------------------------------------------------------+
| Negative Type-I error rate | [{{< fa file-pdf >}}](./figures/Correlation (Negative error).pdf) | [{{< fa file-pdf >}}](./figures/Covariance (Negative error).pdf) |
+----------------------------+-------------------------------------------------------------------+------------------------------------------------------------------+
| Total Type-I error rate    | [{{< fa file-pdf >}}](./figures/Correlation (Total error).pdf)    | [{{< fa file-pdf >}}](./figures/Covariance (Total error).pdf)    |
+----------------------------+-------------------------------------------------------------------+------------------------------------------------------------------+
...
| Outcome measures                   | Correlations                                                                         | Covariances                                                                         |
+====================================+======================================================================================+=====================================================================================+
| Bias and Variance                  | [{{< fa file-pdf >}}](./figures/Correlation (Bias and Variance).pdf)                 | [{{< fa file-pdf >}}](./figures/Covariance (Bias and Variance).pdf)                 |
+------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------+
| Bias and RMSE                      | [{{< fa file-pdf >}}](./figures/Correlation (Bias and RMSE).pdf)                     | [{{< fa file-pdf >}}](./figures/Covariance (Bias and RMSE).pdf)                     |
+------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------+
| Bias and MAE                       | [{{< fa file-pdf >}}](./figures/Correlation (Bias and MAE).pdf)                      | [{{< fa file-pdf >}}](./figures/Covariance (Bias and MAE).pdf)                      |
+------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------+
| Positive and negative Type-I error | [{{< fa file-pdf >}}](./figures/Correlation (Positive error and Negative error).pdf) | [{{< fa file-pdf >}}](./figures/Covariance (Positive error and Negative error).pdf) |
+------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------+
| Positive and total Type-I error    | [{{< fa file-pdf >}}](./figures/Correlation (Positive error and Total error).pdf)    | [{{< fa file-pdf >}}](./figures/Covariance (Positive error and Total error).pdf)    |
+------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------+
| Negative and total Type-I error    | [{{< fa file-pdf >}}](./figures/Correlation (Negative error and Total error).pdf)    | [{{< fa file-pdf >}}](./figures/Covariance (Negative error and Total error).pdf)    |
+------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------+
